class Login extends Window {
    ...
    createLoginForm() {
        ...
        form.onsubmit = async (e) => {
            e.preventDefault();
            await this.handleLogin(usernameInput.value, passwordInput.value, errorMsg);
        };
        ...
        form.append(usernameInput, passwordInput, submitButton, errorMsg, registerButton);
    ...
    async handleLogin(username, password, errorMsg) {
        try {
            ...
            if (result.success) {
                ...
                this.showError(errorMsg, result.error || "Erreur de connexion");
            }
        } catch (error) {
